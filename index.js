...
function checkTitleField() {
    ...
    createButton.style.backgroundColor = (collectionTitle.value) ? 'rgb(14 165 233)' : 'rgb(7, 89, 133)'
}
...
**/
const collections = []
const defaultCollection = new DefaultCollection('Have You?', 'This is your default collection')
const secondCollection = new Collection('Shopping list', 'this is my weekly shopping list')
